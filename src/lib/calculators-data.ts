...
export const calculators: CalculatorDef[] = [
  // Health
  {
    ...
    isFeatured: true,
    image: { seed: 'bmi', width: 600, height: 400, hint: 'health scale' },
    inputs: [
  ...
  },
  {
    ...
    isFeatured: true,
    image: { seed: 'bmr', width: 600, height: 400, hint: 'metabolism energy' },
    inputs: [
  ...
  // Finance
  {
    ...
    isFeatured: true,
    image: { seed: 'loan', width: 600, height: 400, hint: 'finance loan' },
    inputs: [
  ...
  },
  {
    ...
    isFeatured: true,
    image: { seed: 'sip', width: 600, height: 400, hint: 'investment growth' },
    inputs: [
  ...
  },
  {
    ...
    image: { seed: 'interest', width: 600, height: 400, hint: 'money interest' },
    inputs: [
  ...
  // Mathematics
  {
    ...
    isFeatured: true,
    image: { seed: 'percentage', width: 600, height: 400, hint: 'math percent' },
    inputs: [
  ...
  // Conversion & Tools
  {
    ...
    isFeatured: true,
    image: { seed: 'age', width: 600, height: 400, hint: 'birthday cake' },
    inputs: [
  ...
  },
  {
    ...
    isFeatured: true,
    image: { seed: 'units', width: 600, height: 400, hint: 'measuring tape' },
    inputs: [
  ...
  },
  {
    ...
    isFeatured: true,
    image: { seed: 'discount', width: 600, height: 400, hint: 'sale tag' },
    inputs: [
  ...
  },
  {
    ...
    image: { seed: 'date_diff', width: 600, height: 400, hint: 'calendar dates' },
    inputs: [
